    ...
    return (
        <section className="video-content-header-meta">
            <div className="video-content-header-meta-item">
                <h1 className="video-content-header-meta__title">{channelVideoPrimary.title}</h1>
            ...
            <VideoMenu likes={channelVideoPrimary.likes} dislikes={channelVideoPrimary.dislikes} />
        </section>
    );
}
