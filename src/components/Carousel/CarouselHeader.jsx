...
function CarouselHeader({ isChannel, isRecommended, needArrows, channelImage, title, subsNumber }) {
    return (
        <header className="carousel-header">
            <section className="carousel-header-items">
                ...
                {isRecommended && (
                    <p className="carousel-header__subtitle">Recommended channel for you</p>
                )}
            </section>
